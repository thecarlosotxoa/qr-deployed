...
# Generate QR code
@qr_routes.route("/api/generate-qr", methods=["POST"])
def generate_qr():
...
@qr_routes.route("/api/user/qr-codes", methods=["GET"])
...
# Save QR code
@qr_routes.route('/api/user/save-qr', methods=['POST'])
def save_qr_code():
...
# Delete a QR code
@qr_routes.route('/api/user/delete-qr/<int:id>', methods=['DELETE'])
